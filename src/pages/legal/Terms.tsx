    ...
    <div className="max-w-4xl mx-auto px-6 py-12 space-y-12 pb-24">
      ...
      <section className="space-y-8 text-gray-400 font-medium leading-relaxed">
        <div className="p-8 glass-card border-brand-gold/20 bg-brand-gold/5 space-y-4">
          ...
          <p>
            En accédant à AfriStory, vous acceptez de respecter ces conditions. Si vous n'êtes pas d'accord, veuillez cesser toute utilisation du service.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p>
            Tous les contenus publiés sur AfriStory restent la propriété exclusive de leurs auteurs respectifs. La plateforme dispose d'une licence de diffusion non-exclusive.
          </p>
        </div>

        <div className="space-y-4">
          <h2 className="text-xl font-display font-black uppercase text-white flex items-center gap-3">
             <CheckCircle className="w-6 h-6 text-brand-gold" /> 3. Monétisation & AfriCoins
          </h2>
          <p>
            Les AfriCoins sont des crédits virtuels utilisables uniquement sur la plateforme. Tout achat est définitif et non remboursable, sauf erreur technique avérée.
          </p>
        </div>
      </section>

      <div className="bg-white/5 p-8 rounded-3xl border border-white/10 italic text-sm">
        Pour toute question relative à ces conditions, contactez legal@afristory.africa
      </div>
    </div>
  );
}
